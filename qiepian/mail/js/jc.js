...
$(function(){
	...
	jcheng()
	//解决要拉动窗口才能计算子元素的问题，暂时这样把（！！！）
	  $(window).bind("myResize",jcheng);
	 ...
	 function jcheng(){
		 ...
		 console.log('标题'+titleH);
		 //jc容器的其中一个元素高度为
		 var jcItemHeight = $jc.get(0).offsetHeight;
		 console.log($jc.eq(0))
		 console.log('高度'+jcItemHeight);
